//
//  NNBlockFundTransferReocrdViewController.m
//  YWL
//
...
@interface NNBlockFundTransferReocrdViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation NNBlockFundTransferReocrdViewController
{
    NSInteger _page;
}

#pragma mark - Life Cycle Methods
- (instancetype)initTransferRecordWithTransferType:(NNHWalletTransferType)transferType
{
    if (self = [super init]) {
...
- (void)loadListDataRefresh:(BOOL)isRefresh
{
    ...
    NNAPIBlockFundTransferTool *blockTool = [[NNAPIBlockFundTransferTool alloc] initWalletTransferRecordWithTransferType:self.currentTransferType page:_page];
