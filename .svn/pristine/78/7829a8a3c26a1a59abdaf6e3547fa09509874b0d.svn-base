...
- (void)addBankCardAction
{
    ...
    [cardTool nnh_StartRequestWithSucBlock:^(NSDictionary *responseDic) {
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            [NNHProjectControlCenter sharedControlCenter].userControl_currentUserModel.banknumber = @"1";
...
{
    NNHBankCardAddCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([NNHBankCardAddCell class])];
...
- (UITableView *)tableView
{
    if (_tableView == nil) {
        ...
        [_tableView registerClass:[NNHBankCardAddCell class] forCellReuseIdentifier:NSStringFromClass([NNHBankCardAddCell class])];
...
- (UIView *)footerView
{
    if (_footerView == nil) {
        ...
        UIButton *submitButton = [UIButton NNHOperationBtnWithTitle:@"确定" target:self action:@selector(addBankCardAction) operationButtonType:NNHOperationButtonTypeBlue isAddCornerRadius:YES];
