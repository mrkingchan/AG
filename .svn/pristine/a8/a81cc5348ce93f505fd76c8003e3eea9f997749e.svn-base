...
{
    if (_rightArrow == nil) {
        _rightArrow = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"mine_order_arrow"]];
    }
    return _rightArrow;
}
...
- (UIView *)rightView
{
    if (_rightView == nil) {
        ...
        UIImageView *rightArrow = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"mine_order_arrow"]];
