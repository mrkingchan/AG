...
@interface NNHScanCodeController () <AVCaptureMetadataOutputObjectsDelegate>
...
- (void)lightBtnOnClick:(UIButton *)btn
{
    //判断是否有闪光灯
    if (![_device hasTorch]) {
        [[NNHAlertTool shareAlertTool] showAlertView:self title:@"当前设备没有闪光灯，无法开启照明功能" message:nil cancelButtonTitle:@"取消" otherButtonTitle:@"确定" confirm:^{
